...
public:
    ...
    const std::string target_id)
  {
    ...
    RCLCPP_INFO(LOGGER_EE_INTERFACE, "Attaching to robot ee frame: [%s]", ee_link.c_str());
    ...
    const std::string target_id)
  {
    ...
    RCLCPP_INFO(LOGGER_EE_INTERFACE, "Detaching from robot ee frame: [%s]", ee_link.c_str());
